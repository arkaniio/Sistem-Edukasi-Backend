...
let ResultsController = class ResultsController {
    ...
    async getRecentResults(user) {
        return await this.resultsService.getRecentResults(user.userId);
    }
    async uploadCsv(body, user) {
        return await this.resultsService.processCsv(user.userId, body.classId, body.subjectId);
    }
    async getEraper(user) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [upload_csv_dto_1.UploadCsvDto, Object]),
    __metadata("design:returntype", Promise)
