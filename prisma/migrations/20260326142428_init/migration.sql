...
-- AddForeignKey
ALTER TABLE "CBTTest" ADD CONSTRAINT "CBTTest_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CBTQuestion" ADD CONSTRAINT "CBTQuestion_testId_fkey" FOREIGN KEY ("testId") REFERENCES "CBTTest"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CbtAttempt" ADD CONSTRAINT "CbtAttempt_testId_fkey" FOREIGN KEY ("testId") REFERENCES "CBTTest"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
